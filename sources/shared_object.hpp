...
namespace sdl
{
///\brief Represent a shared object (dynamic library, dynamically loaded
///library, module, plugin...).
///
/// This class wraps a platform-specific "handle" to a loaded library.
/// An instanciated SharedObject permit to retrieve callable function from them
/// in a cross-platform way. This class automatically manages the lifetime of the
/// loaded library for you
class SharedObject
{
...
public:
	...
	/// Retrieve the raw address of a function inside the owned object. User has
	/// to cast this to the correct function pointer type
	...
	/// Syntactic sugar overload, provide you a way to specify the actual type
	/// of the function pointer
	/// e.g: mySharedObject.function_pointer<returnType (*)
	/// (args)>("nameOfExportedFunciton");
	///\param functionName The name of a callable symbol that can be found in
	///the loaded library

...
public:
	...
	/// Construct an sdl Color object with the given 8 bit color values. Alpha
	/// channel to fully opaque by default
	...
	/// Converting constructor that will initialize the color with a given 32
	/// bit value, according to the provided PixelFormat
	...
	/// Putput stream overloadc that will print the value of the current color
	/// as a 4D vector of 8bit numbers
